...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    p.add_argument(
        "--entailment", choices=("llm", "embedding", "deberta"), default="llm",
    ...
    p.add_argument("--cluster-threshold", type=float, default=0.88,
    ...
    p.add_argument("--no-final-judge", action="store_true",
...
def main(argv: list[str] | None = None) -> None:
    ...
    problems = (
        SAMPLE_PROBLEMS if args.problem == "all" else [get_problem(args.problem)]
    )
    ...
    for prob in problems:
        ...
        print(f"=== {prob['id']} ===")
        print(f"{'strategy':<12}{'novelty':>9}{'step-conv':>11}"
        ...
        for strat in strategies:
            ...
            print(f"{strat:<12}{res.mean_novelty:>9.3f}"
...
def _serialise(problem_id: str, res) -> dict:
    ...
    return {
        ...
        "final_judge": None if res.final_judge is None else {
        ...
        "steps": [
            {
                ...
                "candidates": [
                    {
                        "text": c.text, "novelty": c.novelty,
                        "convergent": c.convergent, "cluster_id": c.cluster_id,
                        "logprob": c.logprob, "on_frontier": c.on_frontier,
                    }
